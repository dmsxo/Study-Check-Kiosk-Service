...
import { QrCode, CheckCircle, XCircle, Clock, Home } from 'lucide-react';
        ...
        return (
          <div className="flex flex-col items-center gap-16">
            ...
            <div className="flex gap-3">
              ...
              <div className="w-4 h-4 bg-gray-900 rounded-full animate-bounce" style={{ animationDelay: '0.15s' }}></div>
              <div className="w-4 h-4 bg-gray-900 rounded-full animate-bounce" style={{ animationDelay: '0.3s' }}></div>
            </div>
          </div>
        );
      case 'scanning':
        return (
          <div className="flex flex-col items-center gap-16">
            <Clock size={140} className="text-gray-900 animate-spin" strokeWidth={1.5} style={{ animationDuration: '2s' }} />
            <div className="text-center space-y-4">
              <h1 className="text-5xl font-bold text-gray-900">
                인증 중
              </h1>
  ...
  return (
    <div className="min-h-screen flex flex-col justify-between items-center bg-white p-8">
      ...
      <button
        ...
        className="w-full max-w-md px-12 py-5 bg-gray-100 text-gray-900 text-xl font-bold rounded-3xl hover:bg-gray-200 transition-all duration-200 active:scale-95 mb-8"
      >
        홈으로
      </button>
    </div>
